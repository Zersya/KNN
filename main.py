...
#region parameter yang perlu atur
K = 7                   #atur K nya berapa, saya mendapat 4 karena hasil akurasi lebih maksimal pada saat training dengan train Data
    ...
    with open('DataTrain_Tugas3_AI.csv') as csv_file:
        ...
        for row in csv_reader:
            if line_count == 0:
                ...
                line_count += 1
            if hitungRata[0] == trainRata and hitungRata[1] == trainRata and hitungRata[2] == trainRata and hitungRata[3] == trainRata and line_count-1 == (trainRata*len(hitungRata)):
                break
